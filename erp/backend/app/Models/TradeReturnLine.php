...
class TradeReturnLine extends Model
{
    protected $fillable = ['company_id', 'return_id', 'item_id', 'line_number', 'quantity', 'unit_price', 'tax_rate', 'tax_amount', 'line_total', 'cost_amount'];
