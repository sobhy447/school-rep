...
internal abstract class RepositoryBase<TAggregate>(IdentityDbContext context) : IRepository<TAggregate, long>
    where TAggregate : AggregateRoot<long>
{
    protected IdentityDbContext Context { get; } = context;
